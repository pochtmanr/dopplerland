...
export function BlogContent({ content, locale }: BlogContentProps) {
  ...
  return (
    <article
      dir={isRtl ? "rtl" : "ltr"}
      className={`
        prose prose-invert dark:prose-invert max-w-none
        ...
        prose-blockquote:border-l-4 prose-blockquote:border-accent-teal prose-blockquote:bg-overlay/5 prose-blockquote:py-6 prose-blockquote:px-8 prose-blockquote:rounded-e-xl prose-blockquote:not-italic prose-blockquote:text-text-secondary prose-blockquote:text-[1.25rem] prose-blockquote:my-12
        prose-code:text-accent-teal-light prose-code:bg-overlay/10 prose-code:px-2 prose-code:py-1 prose-code:rounded-md prose-code:text-lg prose-code:before:content-none prose-code:after:content-none
        prose-pre:bg-bg-secondary prose-pre:border prose-pre:border-overlay/10 prose-pre:rounded-xl prose-pre:my-12
        prose-img:rounded-2xl prose-img:my-14
        prose-hr:border-overlay/20 prose-hr:my-16
