...
export default function ConversationPage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 h-auto lg:h-[calc(100vh-4rem)]">
      {/* Left: Chat */}
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        {/* Chat messages */}
        <div className="border border-overlay/10 rounded-lg p-4 space-y-3 flex-1 overflow-y-auto min-h-0 max-h-[60vh] lg:max-h-none">
          {messages.length === 0 ? (
